...
/**
 * A  ServletContextInitializer} to register {@link Filter}s in a Servlet 3.0+
 ...
 * {@link (ServletContext)}. Registrations can be associated with
 * { URL patterns} and/or servlets (either by { setServletNames
 * name} or via a  setServletRegistrationBeans ServletRegistrationBean}s. When no
...
public class FilterRegistrationBean extends AbstractFilterRegistrationBean {
     ...
     * @param servletRegistrationBeans associate {ServletRegistrationBean}s
     */
